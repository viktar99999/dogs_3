...
scaler = MinMaxScaler()
regressor = RandomForestRegressor(n_estimators = 100, max_features = 'log2', max_depth = 14, n_jobs = 4, random_state = 42)
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
r2(y_test, y_pred) / (-1.0)
print(r2(y_test, y_pred) / (-1.0))
